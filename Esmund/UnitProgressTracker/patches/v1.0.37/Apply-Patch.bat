...
cd /d "%~dp0"
echo ========================================
echo  Unit Progress Tracker Patch v1.0.37
echo  Replace scan Inventor path fix
echo ========================================
echo.
set "TARGET=%~1"
...
echo.
echo New in v1.0.37:
echo   - Fix replace scan path matching (same Inventor read as full scan)
echo   - Show real Inventor errors instead of sidecar/CONFIG_JSON messages
echo   - Removed CONFIG_JSON folder fallback
